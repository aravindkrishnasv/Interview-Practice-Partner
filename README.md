...
* **Reasoning:** To prevent "role leakage." During the interview, the **Interviewer Agent** is strictly forbidden from giving feedback. This ensures the user feels the pressure of a real interview. The **Evaluator Agent** is instantiated only at the end to review the transcript objectively.
